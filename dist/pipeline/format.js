...
function formatEvent() {
  ...
  var title = attributes.title,
    ...
    exclusionDatesInputType = attributes.exclusionDatesInputType,
    exclusionDatesOutputType = attributes.exclusionDatesOutputType,
  ...
  icsFormat += exclusionDates ? (0, _utils.foldLine)("EXDATE:".concat((0, _encodeNewLines["default"])(exclusionDates.map(function (a) {
    return (0, _utils.formatDate)(a, exclusionDatesOutputType, exclusionDatesInputType);
  }).join(',')))) + '\r\n' : '';
